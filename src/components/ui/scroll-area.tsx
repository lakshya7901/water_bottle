...
>(({ className, orientation = "vertical", ...props }, ref) => (
  <ScrollAreaPrimitive.ScrollAreaScrollbar
    ...
    /* Updated for a smoother, water-themed appearance */
    className={cn(
  ...
  >
    <ScrollAreaPrimitive.ScrollAreaThumb 
      className={cn(
        ...
        /* Using primary blue with low opacity to match the water-wash theme */
        "bg-primary/20 hover:bg-primary/40 active:bg-primary/60"
      )} 
    />
  </ScrollAreaPrimitive.ScrollAreaScrollbar>
));
