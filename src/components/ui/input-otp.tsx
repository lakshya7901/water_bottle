...
>(({ index, className, ...props }, ref) => {
  ...
  return (
    <div
      ref={ref}
      className={cn(
        /* Updated to use glass-card style for each slot */
        "relative flex h-12 w-10 md:w-12 items-center justify-center border border-primary/10 bg-background/40 backdrop-blur-sm text-lg font-display font-bold transition-all rounded-xl",
        isActive && "z-10 ring-2 ring-primary ring-offset-2 ring-offset-background bg-primary/5 shadow-glow",
        className,
      )}
      {...props}
    >
